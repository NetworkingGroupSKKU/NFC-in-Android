...
public class ProfileSupport {
	...
	public static Setting getProfileFromProfileURLSuffix(String profileURLSuffix) {
	...
	public static String getProfileURLSuffix(Setting profile) {
	...
	public static Setting getProfileFromPreferences(
