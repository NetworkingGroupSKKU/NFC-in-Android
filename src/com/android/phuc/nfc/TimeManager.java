...
public class TimeManager extends Preference implements
	...
	public TimeManager(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public TimeManager(Context context, AttributeSet attrs, int defStyle) {
	...
	private void init() {
		...
		dialog = builder.create(R.layout.dialog_layout);
	}
